    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
          <a class="navbar-brand brand-logo" href="index.html"><img src="{{asset('style/dist/assets/images/logo.svg')}}" alt="logo" /></a>
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                <div class="nav-profile-img">
                  <img src="{{asset('style/dist/assets/images/faces/face1.jpg')}}" alt="image">
              ...
              <div class="dropdown-menu dropdown-menu-end navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="{{asset('style/dist/assets/images/faces/face4.jpg')}}" alt="image" class="profile-pic">
                  </div>
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="{{asset('style/dist/assets/images/faces/face2.jpg')}}" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="{{asset('style/dist/assets/images/faces/face3.jpg')}}" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
            ...
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                <div class="nav-profile-image">
                  <img src="{{asset('style/dist/assets/images/faces/face1.jpg')}}" alt="profile" />
            ...
            <div class="row">
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    <img src="{{asset('style/dist/assets/images/dashboard/circle.svg')}}" class="card-img-absolute" alt="circle-image" />
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src="{{asset('style/dist/assets/images/faces/face1.jpg')}}" class="me-2" alt="image"> David Grey
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src="{{asset('style/dist/assets/images/faces/face2.jpg')}}" class="me-2" alt="image"> Stella Johnson
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src="{{asset('style/dist/assets/images/faces/face3.jpg')}}" class="me-2" alt="image"> Marina Michel
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src="{{asset('style/dist/assets/images/faces/face4.jpg')}}" class="me-2" alt="image"> John Doe
                            </td>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mt-3">
                      <div class="col-6 pe-1">
                        <img src="{{asset('style/dist/assets/images/dashboard/img_1.jpg')}}" class="mb-2 mw-100 w-100 rounded" alt="image">
                        <img src="{{asset('style/dist/assets/images/dashboard/img_4.jpg')}}" class="mw-100 w-100 rounded" alt="image">
                      </div>
                      <div class="col-6 ps-1">
                        <img src="{{asset('style/dist/assets/images/dashboard/img_2.jpg')}}" class="mb-2 mw-100 w-100 rounded" alt="image">
                        <img src="{{asset('style/dist/assets/images/dashboard/img_3.jpg')}}" class="mw-100 w-100 rounded" alt="image">
                      </div>
                    </div>
                    <div class="d-flex mt-5 align-items-top">
                      <img src="{{asset('style/dist/assets/images/faces/face3.jpg')}}" class="img-sm rounded-circle me-3" alt="image">
